...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5(data-aos="flip-up")
      ...
      .col-lg-10
        p.mb-5 El uso abusivo y prolongado de dispositivos electrónicos afectan tanto física como mentalmente a las personas, generando depresión, ansiedad, riesgo de suicidio y adicciones; así como fallas en la atención, memoria y aprendizaje. El siguiente recurso ampliará la información con respecto al uso prolongado de los dispositivos:
